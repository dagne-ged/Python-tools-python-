...
def SqueezeNet(nb_classes, inputs=(224, 224, 3)):
    ...
    :param inputs: shape of the input images (cols, rows, channel )
    ...
    return Model(inputs=input_img, outputs=global_avgpool10)       # 此处修改,输出logits，不做softmax
